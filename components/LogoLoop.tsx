...
export interface LogoLoopItem {
  node?: ReactNode | ComponentType<Record<string, unknown>>;
  src?: string;
  srcSet?: string;
  sizes?: string;
  width?: number;
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        ...
        // Dynamically handle functional components (e.g., SiReact) or React Elements
        let nodeContent = null;
        if (isNodeItem) {
          const NodeComponent = item.node;
          nodeContent =
            typeof item.node === "function" ? <NodeComponent /> : item.node;
        }
